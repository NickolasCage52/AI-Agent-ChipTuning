...
**Feedback Loop:** бот собирает оценки пользователей после каждого подбора. Данные используются для улучшения качества. Подробнее: [ADMIN_GUIDE.md](ADMIN_GUIDE.md#feedback-система).
